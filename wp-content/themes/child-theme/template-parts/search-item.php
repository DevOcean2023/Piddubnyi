<article class="search-result__item accessibility-card">
	<div class="search-result__content">
		...
		<p class="search-result__text"><?php dov_the_excerpt( 375 ); ?></p>
		<div class="search-result__more" aria-hidden="true" id="read-more-1"><?php esc_html_e( 'Дивитись більше', 'theme' ); ?></div>
	</div>
