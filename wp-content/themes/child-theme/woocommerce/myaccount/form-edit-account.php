			...
			<div class="wrapper-edit-form">
				<div class="edit-first-form">
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						...
						<input type="tel" class="woocommerce-Input woocommerce-Input--text input-text deactive phone-field" name="account_phone" placeholder="<?php esc_attr_e( 'Телефон*', 'woocommerce' ); ?>" id="account_phone" value="<?php echo esc_attr( get_user_meta( $user->ID, 'billing_phone', true ) ); ?>" readonly />
					</p>
