...
?>
	<div class="reset__wrapper">
		...
		<form method="post" class="woocommerce-ResetPassword lost_reset_password">
			...
			<p><?php echo apply_filters( 'woocommerce_lost_password_message', esc_html__( 'Відновити пароль', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>

			<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
				<input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="user_login"
					   placeholder="<?php esc_attr_e( 'Email*', 'woocommerce' ); ?>" id="user_login"
			...
			<p class="woocommerce-form-row form-row">
				...
				<button type="submit"
						...
						value="<?php esc_attr_e( 'Надіслати', 'woocommerce' ); ?>"><?php esc_html_e( 'Надіслати', 'woocommerce' ); ?></button>
			</p>
