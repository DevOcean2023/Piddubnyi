	...
	<div class="container-form">
		<div class="container-button">
			...
			<div class="login-button form-login-registration-button">
				<button class="close-login"><?php esc_html_e( 'Реєстрація', 'woocommerce' ); ?></button>
			</div>
		</div>
		<div id="u-column1" class="u-column1 col-1">
			<div class="login-form__wrapper">
				<form class="woocommerce-form woocommerce-form-login login" method="post">
					...
					<div class="lost__wrapper">
						<p>
							<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
								<input class="woocommerce-form__input woocommerce-form__input-checkbox"
									   name="rememberme"
									   type="checkbox" id="rememberme" value="forever"/>
								<span><?php esc_html_e( "Запам'ятати мене", 'woocommerce' ); ?></span>
							</label>
							<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
						</p>
						<p class="woocommerce-LostPassword lost_password">
							<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Забули пароль?', 'woocommerce' ); ?></a>
						</p>
		...
		<div id="u-column2" class="u-column2 col-2">
			<div class="login-form__wrapper">
				<form method="post" class="woocommerce-form woocommerce-form-register register">
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<input type="text" class="woocommerce-Input woocommerce-Input--text input-text"
							   ...
							   placeholder="<?php esc_attr_e( 'Ваше Ім’я та Прізвище*', 'woocommerce' ); ?>"
							   value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>"/><?php // @codingStandardsIgnoreLine ?>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="email"
							   ...
							   placeholder="<?php esc_attr_e( 'E mail*', 'woocommerce' ); ?>"
							   value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( wp_unslash( $_POST['email'] ) ) : ''; ?>"/><?php // @codingStandardsIgnoreLine ?>

						<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
					<p class="text-error" style="display: none;">Паролі не співпадають!</p>
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<span class="password-input">
							<input type="password"
								   class="woocommerce-Input woocommerce-Input--text input-text"
								   name="password" id="reg_password"
								   placeholder="<?php esc_attr_e( 'Пароль*', 'woocommerce' ); ?>"
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<span class="password-input">
							<input type="password"
								   class="woocommerce-Input woocommerce-Input--text input-text"
								   name="confirm_password" id="reg_confirm_password"
				...
				<?php endif; ?>
					...
					<button type="submit"
							...
							name="register"
							value="<?php esc_attr_e( 'Зареєструватись', 'woocommerce' ); ?>"><?php esc_html_e( 'Зареєструватись', 'woocommerce' ); ?></button>
