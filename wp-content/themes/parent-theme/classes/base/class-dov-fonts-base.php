...
//		}
	...
	public static function add_fonts_js() : void {
		$font_dir   = DOV_File::get_assets_path( 'fonts/' );
		$js_content = DOV_Filesystem::get_file_contents( $font_dir . 'fonts.js' );
		if ( $js_content ) {
			printf(
	...
	public static function add_fonts_css() : void {
		$font_dir    = DOV_File::get_assets_path( 'fonts/' );
		$css_content = DOV_Filesystem::get_file_contents( $font_dir . 'fonts.css' );
		if ( $css_content ) {
	...
	protected static function get_url( $file_name = '' ) : string {
		static $font_url;
		if ( null === $font_url ) {
			$font_url = DOV_File::get_assets_url( 'fonts/' );
		}
