 ...
 * ```
 * require_once dirname( __DIR__ ) . '/parent-theme/inc/class-dov-sub-themes.php';
 *
 * DOV_Sub_Themes::init();
 * ```
 *
 ...
 */
class DOV_Sub_Themes_Base {
	public static string $directory_name = 'sub-themes';

	public static function init() : void {
		static::$directory_name = apply_filters( 'dov_sub_themes_directory_name', static::$directory_name );
		...
		add_filter(
			'pre_option_dov_other_favicon_html',
	...
	public static function the_sub_theme_content() : void {
		...
		if ( file_exists( DOV_File::get_assets_path( '/template-parts/header.php' ) ) ) {
		...
		if ( file_exists( DOV_File::get_assets_path( '/template-parts/footer.php' ) ) ) {
