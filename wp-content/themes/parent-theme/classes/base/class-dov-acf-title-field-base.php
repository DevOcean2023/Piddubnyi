 ...
 * Uncaught Error: Typed static property DOV_ACF_Title_Field_Base::$has_main_auto_title must not be accessed before initialization
 * @noinspection PropertyInitializationFlawsInspection
 */

class DOV_ACF_Title_Field_Base extends DOV_ACF_Replace_Text_Field {
	...
	public function initialize() : void {
		...
		$this->defaults['default_level'] = apply_filters( 'dov_acf_title_default_level', false, 0 );
	}
	...
	public function render_field( array $field ) : void {
		...
		$only_auto_level = apply_filters( 'dov_acf_title_only_auto_level', true, $field );
		$level_atts      = array(
	...
	public function format_value( $value, $post_id, array $field ) : string {
		...
		if ( apply_filters( 'dov_acf_title_only_auto_level', true, $field ) ) {
	...
	public function input_admin_enqueue_scripts() : void {
		wp_enqueue_style(
			'dov-acf-title-field',
			DOV_File::get_parent_url( 'css/dov-acf-title-field.css' ),
			array( 'acf-input' ),
