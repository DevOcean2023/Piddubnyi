...
class DOV_Juicer_Feed_Base {
	...
	public static function the( string $feed_name, array $feed_attributes = array() ) : void {
		...
		if ( class_exists( 'Juicer_Feed' ) ) {
			...
			echo wp_kses( $juicer_feed->render( $feed_attributes ), DOV_KSES::get_by_tag( 'a' ) );
		}
	}
}
