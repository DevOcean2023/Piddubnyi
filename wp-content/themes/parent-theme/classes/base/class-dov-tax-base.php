...
class DOV_Tax_Base {
	public const KEY = 'dov_tax_slug_';
	...
	public static function init() : void {
		...
		if ( defined( 'DOV_TAX_SET_DEFAULT_TERM' ) && DOV_TAX_SET_DEFAULT_TERM ) {
	...
	public static function get_single_label( string $taxonomy ) : string {
		...
		return apply_filters( 'dov_get_taxonomy_label_plural', $label, $taxonomy );
	}
	...
	public static function get_plural_label( string $singular, string $taxonomy ) : string {
		...
		return apply_filters( 'dov_get_cpt_label_plural', $label, $taxonomy );
	}
	...
	public static function replace_tags( string $post_link, ?WP_Post $post ) : string {
		foreach ( static::$tags as $taxonomy => $tag ) {
			if ( str_contains( $post_link, $tag ) ) {
				...
				} elseif ( defined( 'DOV_TAX_SET_DEFAULT_TERM' ) && DOV_TAX_SET_DEFAULT_TERM ) {
