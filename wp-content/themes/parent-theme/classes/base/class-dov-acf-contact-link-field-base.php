...
class DOV_ACF_Contact_Link_Field_Base extends acf_field {
	public array $link_types = array();

	public function initialize() : void {
		$this->name       = 'dov_contact_link';
	...
	public function render_field( array $field ) : void {
		...
		?>
		<div class="acf-dov-contact-link">
			<div class="dov-contact-link-wrap">
				<div class="dov-contact-link-value">
					<div>
						<label for="<?php echo esc_attr( $field['id'] ); ?>_title">
							<?php esc_html_e( 'Title:', 'theme' ); ?>
						</label>
						<div class="dov-contact-link-input">
							<div class="acf-input">
		...
		if ( DOV_Theme::never() ) { // The condition is never fulfilled, only for IDE
			echo '<div class="acf-field acf-field-dov-contact-link"></div>';
		}
	}
	...
	public function input_admin_enqueue_scripts() : void {
		$url = DOV_File::get_parent_url();
		wp_enqueue_script(
			'dov-acf-contact-link-field',
			$url . 'js/dov-acf-contact-link-field.js',
		...
		wp_enqueue_style(
			'dov-acf-contact-link-field',
			$url . 'css/dov-acf-contact-link-field.css',
			array( 'acf-input' ),
			DOV_Theme::get_version()
		);
	}
