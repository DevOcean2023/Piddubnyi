...
class DOV_Fix_GF_Multiple_IDs_Base {
...
//		);
	...
	public static function fix( $form_html_or_confirmation_or_scripts, $form ) {
		...
		$search_replace = array(
			...
			"'gf_submitting_$id'"               => "'gf_submitting_$random_id'",
			"data-formid='$id'"                 => "data-formid='$random_id'",
			...
			"dov_invisible_reload( $id )"                   => "dov_invisible_reload( $random_id )",
			'"formId":' . $id                               => '"formId":' . $random_id,
			"gform_multifile_upload_$id"                    => "gform_multifile_upload_$random_id",
			"gform_drag_drop_area_$id"                      => "gform_drag_drop_area_$random_id",
			"gform_browse_button_$id"                       => "gform_browse_button_$random_id",
			"gfield_upload_rules_$id"                       => "gfield_upload_rules_$random_id",
			"gform_multifile_messages_$id"                  => "gform_multifile_messages_$random_id",
			"gform_preview_$id"                             => "gform_preview_$random_id",
